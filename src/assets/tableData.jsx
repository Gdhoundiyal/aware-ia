export const upcomingMatchesColumns = [
  ...
  },
  {
    ...
    renderCell: (params) => {
      ...
      return (
        <span style={{ color: colors[params.value] }}>{params.value}</span>
      );
    },
  },
];
...
export const standingsColumns = [
  ...
  { field: "D", headerName: "D", width: 60 },
  { field: "GA", headerName: "GA", width: 70 },
  { field: "GF", headerName: "GF", width: 70 },
  { field: "GD", headerName: "GD", width: 70 },
  { field: "PTS", headerName: "QP", width: 70 },
];

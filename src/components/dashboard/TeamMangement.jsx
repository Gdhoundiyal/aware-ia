...
const rows = [
  { id: 1, player: 'John Smith', position: 'Forward', age: 24, currentForm: 'Excellent', fitness: '95%', recommendation: 'Start' },
  { id: 2, player: 'Mike Johnson', position: 'Midfielder', age: 28, currentForm: 'Good', fitness: '88%', recommendation: 'Start' },
  { id: 3, player: 'David Williams', position: 'Defender', age: 22, currentForm: 'Average', fitness: '92%', recommendation: 'Rotation' },
];

...
//       <Grid size={{ xs: 12, sm: 3, md: 3 }} bgcolor={"#fff"} sx={{ borderRight: "1px solid lightgray" }}>
...
//       {/* Content Area */}
//       <Grid size={{ xs: 12, sm: 9, md: 9 }} sx={{bgcolor:"#fff"}}>
//         <Outlet />
//       </Grid>
//     </Grid>
//   );
...
import { useEffect } from "react";
import {
  AccountCircle, People, Business, VpnKey, Security, Notifications, Receipt, Lock, Gavel, Delete
} from "@mui/icons-material";

const sections = [
  { page: "Personal Information", link: "personalInfo", icon: <AccountCircle /> },
  { page: "Team Management", link: "team-management", icon: <People /> },
  { page: "Club Management", link: "club-management", icon: <Business /> },
  { page: "Guest Access", link: "guest-access", icon: <VpnKey /> },
  { page: "Deep Learning", link: "deep-learning", icon: <Lock /> },
  { page: "Subscription & Billing", link: "subscription-billing", icon: <Receipt /> },
  { page: "Security", link: "security", icon: <Security /> },
  { page: "Notifications", link: "notifications", icon: <Notifications /> },
  { page: "Terms & Privacy", link: "privacy", icon: <Gavel /> },
  { page: "Close Account", link: "close-account", icon: <Delete />, isDanger: true },
];
